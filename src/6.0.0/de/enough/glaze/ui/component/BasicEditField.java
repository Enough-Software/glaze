...
public class BasicEditField extends
		net.rim.device.api.ui.component.BasicEditField implements GzField {
	...
	public BasicEditField(String label, String initialValue, int maxNumChars,
			long style) {
