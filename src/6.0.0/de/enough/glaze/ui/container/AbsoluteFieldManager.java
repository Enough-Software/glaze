...
public class AbsoluteFieldManager extends
		net.rim.device.api.ui.container.AbsoluteFieldManager implements
		GzManager {
	 ...
	 * 
	 * @see
	 * net.rim.device.api.ui.container.AbsoluteFieldManager#add(net.rim.device
	 * .api.ui.Field, int, int)
	 */
	...
	/**
	 * Adds the given field and style at the given position
	 * 
	 * @param field
	 *            the field
	 * @param x
	 ...
	 *            the style
	 */
	public void add(Field field, int x, int y, Style style) {
		super.add(field, x, y);
		this.styleManager.add(field, style);
	}
	 ...
	 * 
	 * @see
	 * de.enough.glaze.ui.delegate.GzManager#insert(net.rim.device.api.ui.Field,
	 * int, de.enough.glaze.style.Style)
	 */
