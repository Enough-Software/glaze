...
public abstract class GzFieldManager extends Manager {

	private FieldStyleHandlerList handlers;

	public GzFieldManager() {
		this(0);
	}

	public GzFieldManager(long style) {
		super(style);
	...
	protected void sublayout(int maxWidth, int maxHeight) {
		...
		sublayout(maxWidth, maxHeight, getFieldCount());
	}

	protected abstract void sublayout(int maxWidth, int maxHeight,
			int fieldCount);
